...
class Todo extends Component {
    ...
    showOngoing = () => {
      this.props.dispatch(actions.showOngoing());
    }
     
    showCompleted = () => {
      this.props.dispatch(actions.showCompleted());
    }
    
    showAll = () => {
      this.props.dispatch(actions.showAll());
    }
                    ...
                    return (
                      item.isVisible &&                 
                       <li 
                        ...
                        <span className='delete-btn' role='button' onClick={this.handleDeletClick.bind(this, item.todoId)}>Delete</span>
                      </li>                    
                    )
                  })
                }
